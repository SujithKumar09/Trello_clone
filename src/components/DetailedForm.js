...
const DetailedForm = (props) => {
  ...
  useEffect(() => {
    console.log(props.data.taskName);
    if (props.data) {
      setDetails({
        ...props.data,
      });
  ...
  return (
    ...
    >
        ...
        rules={[
          {
            type: "number",
            min: 0,
            message: "QA hours cannot be negative",
          },
        ]}
      >
        <InputNumber
          value={details.qaHours}
          name="qaHours"
      ...
      >
        <DatePicker
          value={details.dueDate ? moment(details.dueDate) : null}
      ...
      >
        <DatePicker
          value={details.releaseDate ? moment(details.releaseDate) : null}
